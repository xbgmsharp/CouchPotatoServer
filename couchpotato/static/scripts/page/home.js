Page.Home = new Class({
	...
	indexAction: function(param){
		...
		self.available_list = new MovieList({
			...
			'load_more': false,
			'view': 'list',
			'actions': [MA.IMDB, MA.ALLOCINE, MA.SENSACINE, MA.Trailer, MA.Files, MA.Release, MA.Edit, MA.Readd, MA.Refresh, MA.Delete],
		...
		self.soon_list = new MovieList({
			...
			'actions': [MA.IMDB, MA.ALLOCINE, MA.SENSACINE, MA.Refresh],
			'load_more': false,
			'view': 'thumbs',
